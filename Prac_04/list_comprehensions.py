...
# ßlist comprehension to create a list of integers from the above list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

# ßlist comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
filtered_numbers = [number for number in numbers if number > 9]
print(filtered_numbers)

# ß(more advanced) use a list comprehension and the join string method
...
filtered_names = [name.split()[1] for name in full_names if len(name)>11]
